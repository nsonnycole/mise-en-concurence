 ...
 */
class Administrateur extends \Flair\UserBundle\Entity\Administrateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Flair\\UserBundle\\Entity\\Administrateur' . "\0" . 'nom', 'id', 'email', 'salt', 'password', 'roles', 'dateInscription', 'token', 'emailValide', 'resetToken', 'resetDate');
        }
