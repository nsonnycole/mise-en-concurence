...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/var/www/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairCoreBundle', '/var/www/app/Resources/FlairCoreBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairCoreBundle', '/var/www/src/Flair/CoreBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairOrganismeBundle', '/var/www/app/Resources/FlairOrganismeBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairOrganismeBundle', '/var/www/src/Flair/OrganismeBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairPrestataireBundle', '/var/www/app/Resources/FlairPrestataireBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FlairPrestataireBundle', '/var/www/src/Flair/PrestataireBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/var/www/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    {
        require_once '/var/www/app/../vendor/leafo/lessphp/lessc.inc.php';
    ...
    {
        $this->services['dizda.cloudbackup.database.mongodb'] = $instance = new \Dizda\CloudBackupBundle\Database\MongoDB(array('mysql' => array('all_databases' => false, 'database' => 'mise-en-concurrence', 'db_host' => 'mysql', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => 'root', 'ignore_tables' => array())), '/var/www/app/cache/prod/backup/');
        $instance->setTimeout(300);
        return $instance;
    }
    protected function getDizda_Cloudbackup_Database_MysqlService()
    {
        $this->services['dizda.cloudbackup.database.mysql'] = $instance = new \Dizda\CloudBackupBundle\Database\MySQL(array('mysql' => array('all_databases' => false, 'database' => 'mise-en-concurrence', 'db_host' => 'mysql', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => 'root', 'ignore_tables' => array())), '/var/www/app/cache/prod/backup/');
        $instance->setTimeout(300);
        return $instance;
    }
    protected function getDizda_Cloudbackup_Database_PostgresqlService()
    {
        $this->services['dizda.cloudbackup.database.postgresql'] = $instance = new \Dizda\CloudBackupBundle\Database\PostgreSQL(array('mysql' => array('all_databases' => false, 'database' => 'mise-en-concurrence', 'db_host' => 'mysql', 'db_port' => 3306, 'db_user' => 'root', 'db_password' => 'root', 'ignore_tables' => array())), '/var/www/app/cache/prod/backup/');
        $instance->setTimeout(300);
        return $instance;
    }
    protected function getDizda_Cloudbackup_Manager_BackupService()
    {
        return $this->services['dizda.cloudbackup.manager.backup'] = new \Dizda\CloudBackupBundle\Manager\BackupManager($this->get('logger'), $this->get('dizda.cloudbackup.manager.database'), $this->get('dizda.cloudbackup.manager.client'), $this->get('dizda.cloudbackup.manager.processor'), $this->get('event_dispatcher'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber(new \Vich\UploaderBundle\EventListener\UploaderListener($this->get('vich_uploader.adapter'), $this->get('vich_uploader.annotation_driver'), $this->get('vich_uploader.storage'), $this->get('vich_uploader.file_injector')));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'mise-en-concurrence', 'host' => 'mysql', 'port' => NULL, 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/var/www/src/Flair/CoreBundle/Entity', 1 => '/var/www/src/Flair/UserBundle/Entity'));
    ...
    {
        return $this->services['flair.core.form.type.yes_no_choice'] = new \Flair\CoreBundle\Form\Type\YesNoChoiceType($this->get('flair.core.form.data_transformer.boolean_to_string'), $this->get('translator.default'));
    }
    ...
    {
        return $this->services['gaufrette.documents_fs_filesystem'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local('/var/www/app/../web/documents', true));
    }
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler('/var/www/app/logs/prod.log', 100, true, NULL);
        $instance->pushProcessor($this->get('monolog.processor.psr_log_message'));
        return $instance;
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.application' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    protected function getSecurity_Firewall_Map_Context_ApplicationService()
    {
        ...
        $t = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $s, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($s, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $t->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $u = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($s, array('default_target_path' => '/mon-compte', 'login_path' => '/login', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $u->setProviderKey('application');
        return $this->services['security.firewall.map.context.application'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($r, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.database')), 'application', $a, $c), 2 => $t, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $s, 'application', $u, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $s, array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'post_only' => true, 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate'), $a, $c), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5853ec29ee1fb', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $r, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $s, 'application', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $s, '/login', false), '/', NULL, $a));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/var/www/app/cache/prod/sonata/admin', false);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/var/www/app/cache/prod/translations', 'debug' => false));
        ...
        $instance->addResource('xlf', '/var/www/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ua.xlf', 'ua', 'validators');
        ...
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ar.xliff', 'ar', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.bg.xliff', 'bg', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ca.xliff', 'ca', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.cs.xliff', 'cs', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.de.xliff', 'de', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.en.xliff', 'en', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.es.xliff', 'es', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.eu.xliff', 'eu', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fa.xliff', 'fa', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fi.xliff', 'fi', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fr.xliff', 'fr', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hr.xliff', 'hr', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hu.xliff', 'hu', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.it.xliff', 'it', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ja.xliff', 'ja', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lb.xliff', 'lb', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lt.xliff', 'lt', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.nl.xliff', 'nl', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pl.xliff', 'pl', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt.xliff', 'pt', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt_BR.xliff', 'pt_BR', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ro.xliff', 'ro', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ru.xliff', 'ru', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sk.xliff', 'sk', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sl.xliff', 'sl', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.uk.xliff', 'uk', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.zh_CN.xliff', 'zh_CN', 'SonataCoreBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ar.xliff', 'ar', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lt.xliff', 'lt', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', '/var/www/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('yml', '/var/www/src/Flair/CoreBundle/Resources/translations/messages.fr.yml', 'fr', 'messages');
        $instance->addResource('xlf', '/var/www/src/Flair/AdminBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', '/var/www/src/Flair/UserBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        return $instance;
    }
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => '::form/default_form_theme.html.twig', 2 => 'IvoryCKEditorBundle:Form:ckeditor_widget.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FlairCoreBundle', 1 => 'FlairOrganismeBundle', 2 => 'FlairPrestataireBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension(new \Knp\Menu\Twig\MenuExtension(new \Knp\Menu\Twig\Helper($this->get('knp_menu.renderer_provider'), $this->get('knp_menu.menu_provider'), $b, $a), $a, $b));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/vendor/symfony/swiftmailer-bundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/var/www/vendor/doctrine/doctrine-bundle/Resources/views', 'Doctrine');
        $instance->addPath('/var/www/vendor/sonata-project/core-bundle/Resources/views', 'SonataCore');
        $instance->addPath('/var/www/vendor/sonata-project/block-bundle/Resources/views', 'SonataBlock');
        $instance->addPath('/var/www/vendor/knplabs/knp-menu-bundle/Resources/views', 'KnpMenu');
        $instance->addPath('/var/www/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('/var/www/vendor/sonata-project/admin-bundle/Resources/views', 'SonataAdmin');
        $instance->addPath('/var/www/src/Flair/CoreBundle/Resources/views', 'FlairCore');
        $instance->addPath('/var/www/src/Flair/OrganismeBundle/Resources/views', 'FlairOrganisme');
        $instance->addPath('/var/www/src/Flair/PrestataireBundle/Resources/views', 'FlairPrestataire');
        $instance->addPath('/var/www/vendor/egeloen/ckeditor-bundle/Ivory/CKEditorBundle/Resources/views', 'IvoryCKEditor');
        $instance->addPath('/var/www/src/Flair/AdminBundle/Resources/views', 'FlairAdmin');
        $instance->addPath('/var/www/src/Flair/UserBundle/Resources/views', 'FlairUser');
        ...
        $instance->addPath('/var/www/vendor/knplabs/knp-menu/src/Knp/Menu/Resources/views');
        return $instance;
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/app/../web', false);
    ...
    {
        return $this->services['validator.validator_factory'] = new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'sonata.core.validator.inline' => 'sonata.core.validator.inline', 'sonata.admin.validator.inline' => 'sonata.admin.validator.inline', 'flair.validator.unique_email' => 'flair.validator.unique_email', 'flair.validator.existing_email' => 'flair.validator.existing_email'));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.annotation_driver'), $this->get('vich_uploader.adapter'), array('document' => array('uri_prefix' => '/documents', 'upload_destination' => 'documents_fs', 'namer' => 'vich_uploader.namer_uniqid', 'inject_on_load' => true, 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true)));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_migrations.dir_name' => '/var/www/app/DoctrineMigrations',
            ...
            'dizda_cloud_backup.root_folder' => '/var/www/app/../',
            'dizda_cloud_backup.output_folder' => '/var/www/app/cache/prod/backup/',
            ...
            'sonata.core.form.types' => array(
                ...
                59 => 'flair.core.form.type.yes_no_choice',
                60 => 'ivory_ck_editor.form.type',
                61 => 'invitation_form_type',
            ),
