 ...
 */
class LigneDevis extends \Flair\CoreBundle\Entity\LigneDevis implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'id', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'code', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'libelle', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'quantite', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'prixUnitaire', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'tva', '' . "\0" . 'Flair\\CoreBundle\\Entity\\LigneDevis' . "\0" . 'reponse');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LigneDevis $proxy) {
