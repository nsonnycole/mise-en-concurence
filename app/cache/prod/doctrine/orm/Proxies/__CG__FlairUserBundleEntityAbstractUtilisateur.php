 ...
 */
class AbstractUtilisateur extends \Flair\UserBundle\Entity\AbstractUtilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'email', 'salt', 'password', 'roles', 'dateInscription', 'token', 'emailValide', 'resetToken', 'resetDate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AbstractUtilisateur $proxy) {
